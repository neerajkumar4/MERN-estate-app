...
const Profile = () => {
  ...
  const handleSubmit =async (e)=>{
    ...
    try {
      ...
      const res = await fetch(`https://makestateback.onrender.com/api/user/update/${currentUser._id}`, {
        method: "POST",
        headers: {
  ...
  const handleSignOut = async () => {
    try {
      ...
      const res = await fetch('https://makestateback.onrender.com/api/auth/signout');
      const data = await res.json();
      if (data.success === false) {
  ...
  const handleDeleteUser = async () => {
    try {
      ...
      const res = await fetch(`https://makestateback.onrender.com/api/user/delete/${currentUser._id}`, {
        method: 'DELETE',
      });
      const data = await res.json();
      if (data.success === false) {
  ...
  const handleShowListings = async () => {
    try {
      ...
      const res = await fetch(`https://makestateback.onrender.com/api/user/listings/${currentUser._id}`);
      const data = await res.json();
      if (data.success === false) {
  ...
  const handleListingDelete = async (listingId) => {
    try {
      const res = await fetch(`https://makestateback.onrender.com/api/listing/delete/${listingId}`, {
        method: 'DELETE',
      });
      const data = await res.json();
      if (data.success === false) {
